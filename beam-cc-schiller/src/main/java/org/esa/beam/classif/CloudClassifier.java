...
public class CloudClassifier {
    ...
    private static final double[] ALL_VAR_3_THRESH = new double[]{1.65, 2.35, 3.25};
    ...
    private static final double[] TER_VAR_3_THRESH = new double[]{1.7, 2.5, 3.3};
    ...
    private static final double[] WAT_VAR_3_THRESH = new double[]{1.6, 2.4, 3.4};
    ...
    private static final double[] WAT_SIMPLE_VAR_3_THRESH = new double[]{1.5, 2.45};
    ...
    public static int toFlag_all_var3(double nnVal) {
        return toFlag(nnVal, ALL_VAR_3_THRESH);
    }
    ...
    public static int toFlag_ter_var3(double nnVal) {
        return toFlag(nnVal, TER_VAR_3_THRESH);
    }
    ...
    public static int toFlag_wat_var3(double nnVal) {
        return toFlag(nnVal, WAT_VAR_3_THRESH);
    }
    ...
    public static int toFlag_wat_simple_var3(double nnVal) {
        return toSimpleFlag(nnVal, WAT_SIMPLE_VAR_3_THRESH);
    }
