...
/**
 * Operator used to consolidate cloud flag for VGT. Actually it's more or less a duplication of Proba-V porst processing.
 *
 * @author olafd
 * @since Idepix 2.2
 */
@OperatorMetadata(alias = "idepix.vgt.postprocess",
        ...
        description = "Refines the VGT pixel classification.")
public class GlobAlbedoVgtPostProcessOp extends Operator {
...
//               description = "Refine pixel classification near coastlines. ")
    ...
    public void initialize() throws OperatorException {
        ...
        origCloudFlagBand = finalVgtCloudProduct.getBand(IdepixUtils.IDEPIX_CLOUD_FLAGS);
        ...
        ProductUtils.copyBand(IdepixUtils.IDEPIX_CLOUD_FLAGS, finalVgtCloudProduct, postProcessedCloudProduct, false);
...
//                smFlagTile.getSampleBit(x, y, GlobAlbedoVgtClassificationOp.SM_F_CLOUDSHADOW);
        final boolean smCloud1 = smFlagTile.getSampleBit(x, y, GlobAlbedoVgtClassificationOp.SM_F_CLOUD_1);
        final boolean smCloud2 = smFlagTile.getSampleBit(x, y, GlobAlbedoVgtClassificationOp.SM_F_CLOUD_2);
...
//        final boolean smCloud = smFlagTile.getSampleBit(x, y, GlobAlbedoVgtClassificationOp.SM_F_CLOUD);
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(GlobAlbedoVgtPostProcessOp.class);
        }
    }
}
