 ...
 * @author Olaf Danne
 */
public class IdepixCawaAction extends AbstractVisatAction {
    @Override
    public void actionPerformed(CommandEvent commandEvent) {
        final DefaultSingleTargetProductDialog dialog =
            new DefaultSingleTargetProductDialog(OperatorSpi.getOperatorAlias(CawaOp.class),
                    getAppContext(),
                    "Idepix - Pixel Identification and Classification (CAWA mode)",
                    "IdepixPlugIn");
