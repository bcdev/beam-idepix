...
/**
 * Idepix action for MagicStick algorithm.
 *
 * @author Olaf Danne
 */
public class IdepixMagicStickAction extends AbstractVisatAction {
    ...
    public void actionPerformed(CommandEvent commandEvent) {
        final IdepixDefaultDialog dialog =
            new IdepixDefaultDialog(OperatorSpi.getOperatorAlias(MagicStickOp.class),
                    getAppContext(),
                    "IDEPIX Pixel Identification Tool - MagicStick Algorithm - " + IdepixConstants.IDEPIX_VERSION,
                    "idepixChain","");
        dialog.show();
    }
