...
/**
 * Idepix action for Schiller algorithm.
 *
 * @author Olaf Danne
 */
public class IdepixSchillerAction extends AbstractVisatAction {
    @Override
    public void actionPerformed(CommandEvent commandEvent) {
        final IdepixDefaultDialog dialog =
            new IdepixDefaultDialog(OperatorSpi.getOperatorAlias(SchillerOp.class),
                    getAppContext(),
                    "IDEPIX Pixel Identification Tool - Schiller" +
