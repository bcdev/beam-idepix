 ...
 * @author olafd
 */
public class SunAnglesCalculator {
    /**
     ...
     */
    public static SunAngles calculate(final Calendar calendar, final double lat, final double lon) {
        ...
        return new SunAngles(Math.toDegrees(sza), Math.toDegrees(saa));
    }
